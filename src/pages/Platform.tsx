...
const Platform = () => {
  ...
  const heroParallaxY = useTransform(scrollYProgress, [0, 0.3], [0, -150]);

  return (
    <div ref={containerRef} className="min-h-screen relative overflow-hidden">
      {/* Hero Section with 3D Scene and Parallax */}
      <motion.section 
        style={{ opacity: heroOpacity, scale: heroScale, y: heroParallaxY }}
      ...
      >
        ...
        <div className="relative z-20 container mx-auto px-4 text-center">
          ...
          >
            ...
            >
              <div className="px-4 py-2 rounded-full bg-primary/10 backdrop-blur border border-primary/20">
                <div className="flex items-center gap-2">
                  <Diamond className="w-5 h-5 text-primary animate-pulse" />
            ...
            <div className="relative">
              <motion.span
                className="absolute inset-0 text-6xl md:text-8xl font-bold text-primary blur-3xl opacity-30"
                animate={{ opacity: [0.2, 0.4, 0.2] }}
                transition={{ duration: 3, repeat: Infinity }}
              >
                SKY Platform
              </motion.span>
              <h1 className="text-5xl md:text-8xl font-bold mb-6 tracking-tight relative">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-12">
              {[
                ...
                <motion.div
                  ...
                  className="text-center px-6 py-4 rounded-2xl bg-card/30 backdrop-blur-md border border-border/30"
                >
      ...
      {/* Differentials Section with Glassmorphism */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {diferenciais.map((diff, index) => (
              <motion.div
                ...
                whileHover={{ scale: 1.05, y: -5 }}
                className="p-5 rounded-2xl bg-card/30 backdrop-blur-md border border-border/50 hover:border-primary/50 hover:bg-card/50 transition-all cursor-default group shadow-lg"
              >
