...
// Preços de PACOTE para compra direta (upgrade imediato)
// Valores da tabela affiliate_tier_config
const PLANS: Plan[] = [
  {
    id: 'bronze',
    name: 'Bronze',
  ...
  },
  {
    ...
    price: 2700,
    period: 'único',
    priceId: 'price_silver_package',
    icon: Zap,
    gradient: 'from-slate-400 to-slate-600',
    features: [
      'Tudo do Bronze +',
      'PV mínimo: R$ 1.200/mês',
      'GV mínimo: R$ 6.000/mês',
      '3 indicações qualificadas',
      'Comissão: 20%',
  ...
  },
  {
    ...
    price: 10500,
    period: 'único',
    priceId: 'price_gold_package',
    icon: Crown,
    gradient: 'from-amber-500 to-orange-600',
    popular: true,
    features: [
      'Tudo do Prata +',
      'PV mínimo: R$ 3.000/mês',
      'GV mínimo: R$ 30.000/mês',
      '8 indicações + 3 qualificadas em Prata+',
      'Comissão: 27.5%',
      '⭐ LIBERA VENDA DE PRODUTOS PRÓPRIOS',
      'Criador de Slides VIP + IA',
    ]
  },
  {
    id: 'platinum',
    ...
    features: [
      'Tudo do Ouro +',
      'PV mínimo: R$ 6.000/mês',
      'GV mínimo: R$ 120.000/mês',
      '14 indicações + 4 qualificadas em Ouro+',
      'Comissão: 37.5%',
  ...
  },
  {
    ...
    price: 210000,
    period: 'único',
    priceId: 'price_diamond_package',
    icon: Star,
    gradient: 'from-cyan-500 to-blue-600',
    features: [
      'Tudo do Platina +',
      'PV mínimo: R$ 15.000/mês',
      'GV mínimo: R$ 600.000/mês',
      '33 indicações + 6 qualificadas em Platina+',
      'Comissão máxima: 47.5%',
      'Badge Diamante exclusiva',
      'Mentoria mensal',
      'Pool de bônus global',
    ]
  }
];
