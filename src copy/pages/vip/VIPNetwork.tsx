...
export default function VIPNetwork() {
  ...
  const renderContent = () => {
    ...
    if (path === '/vip/network/lives' || path.endsWith('/network/lives')) return <VIPNetworkLives />;
    if (path === '/vip/network/live' || path.endsWith('/network/live')) return <VIPNetworkLive />;
    ...
    if (path.includes('/network/home')) return <VIPNetworkHome />;
